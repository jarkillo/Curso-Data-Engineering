...
export default function HomePage() {
  ...
  return (
    <div className="max-w-6xl mx-auto space-y-8">
      ...
      <div className="grid md:grid-cols-2 gap-6">
        ...
        <div className="card hover:shadow-lg transition-shadow">
          ...
          <div className="space-y-4">
            <div>
              <p className="text-gray-600 mb-2">10 Módulos completos</p>
        ...
        {/* Game Card */}
        <div className="card hover:shadow-lg transition-shadow bg-gradient-to-br from-primary-50 to-secondary-50">
          <div className="flex items-center space-x-3 mb-4">
            <Gamepad2 className="w-8 h-8 text-primary" />
            <h2 className="text-2xl font-bold text-gray-900">🎮 Juego</h2>
          </div>
          {gameState && (
            <div className="space-y-4">
      ...
      {/* Next Steps */}
      <div className="card">
        <h3 className="text-xl font-bold text-gray-900 mb-4">🎯 Siguiente paso</h3>
        <div className="flex items-center justify-between">
          <div>
            <p className="text-lg font-semibold text-gray-900">
              Módulo 2 - Tema 2: SQL Intermedio
            </p>
            <p className="text-gray-600">JOINs, subconsultas, CTEs y funciones de ventana</p>
          </div>
